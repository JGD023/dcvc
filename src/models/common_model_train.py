...
from ..layers.cuda_train import combine_for_reading_2x, \
    restore_y_2x, restore_y_2x_with_cat_after, add_and_multiply, \
    replicate_pad, restore_y_4x, clamp_reciprocal_with_quant
from .entropy_models_train import BitEstimator, GaussianEncoder, EntropyCoder
...
class CompressionModel(nn.Module):
    ...
    def process_with_mask(self, y, scales, means, mask):
        ...
        if self.gaussian_encoder.force_zero_thres is not None:
            cond = scales_hat > self.gaussian_encoder.force_zero_thres
            y_q = y_q * cond
